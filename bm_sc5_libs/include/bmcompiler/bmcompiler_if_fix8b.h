 ...
 * \param input_shape_dim - The size of the input shape array, aka the rank of the input tensor.
 * \param input_name - The name of the input tensor.
 * \param shape_name - If not NULL, the name of a tensor whose shape specifies the output shape.
 * \param output_shape - The shape of the output tensor. Note that when shape_name!=NULL, valid data for
 *                      this param and the next one `output_shape_dim` should still be provided, although
 *                      they will NOT be honored in the end.
 * \param output_shape_dim - The rank of the output tensor.
 * \param output_name - The name of the output tensor.
